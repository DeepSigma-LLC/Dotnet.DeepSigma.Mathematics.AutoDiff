...
public class ReverseFunctionsTests
{
    ...
    public void Sin_Derivative(double x) =>
        AssertMatchesFD(ReverseFunctions<double>.Sin, Math.Sin, x);
    ...
    public void Cos_Derivative(double x) =>
        AssertMatchesFD(ReverseFunctions<double>.Cos, Math.Cos, x);
    ...
    public void Tan_Derivative(double x) =>
        AssertMatchesFD(ReverseFunctions<double>.Tan, Math.Tan, x);
    ...
    public void Exp_Derivative(double x) =>
        AssertMatchesFD(ReverseFunctions<double>.Exp, Math.Exp, x);
    ...
    public void Log_Derivative(double x) =>
        AssertMatchesFD(ReverseFunctions<double>.Log, Math.Log, x);
    ...
    public void Sqrt_Derivative(double x) =>
        AssertMatchesFD(ReverseFunctions<double>.Sqrt, Math.Sqrt, x);
    ...
    public void Tanh_Derivative(double x) =>
        AssertMatchesFD(ReverseFunctions<double>.Tanh, Math.Tanh, x);

    [Fact]
    public void Abs_PositiveInput()
    {
        var g = ReverseDerivative(ReverseFunctions<double>.Abs, 2.0);
    ...
    {
        var g = ReverseDerivative(ReverseFunctions<double>.Abs, -3.0);
        Assert.Equal(-1.0, g, precision: 12);
    }
    ...
    public void Gradient_CompoundFunction_MatchesFiniteDiff()
    {
        ...
        var adGrad = ReverseDiff<double>.Gradient(
            vars => ReverseFunctions<double>.Sin(vars[0]) * ReverseFunctions<double>.Exp(vars[1]),
            point);
    ...
    public void ForwardAndReverse_AgreeOnGradient()
    {
        ...
        var adGrad = ReverseDiff<double>.Gradient(
            vars => ReverseFunctions<double>.Tanh(vars[0]) + ReverseFunctions<double>.Log(vars[1]),
            point);
