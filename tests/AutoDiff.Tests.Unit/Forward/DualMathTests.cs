...
public class DualFunctionsTests
{
    ...
    public void Sin_Derivative(double x) =>
        AssertMatchesFD(DualFunctions<double>.Sin, Math.Sin, x);
    ...
    public void Cos_Derivative(double x) =>
        AssertMatchesFD(DualFunctions<double>.Cos, Math.Cos, x);
    ...
    public void Tan_Derivative(double x) =>
        AssertMatchesFD(DualFunctions<double>.Tan, Math.Tan, x);
    ...
    public void Exp_Derivative(double x) =>
        AssertMatchesFD(DualFunctions<double>.Exp, Math.Exp, x);
    ...
    public void Log_Derivative(double x) =>
        AssertMatchesFD(DualFunctions<double>.Log, Math.Log, x);
    ...
    public void Sqrt_Derivative(double x) =>
        AssertMatchesFD(DualFunctions<double>.Sqrt, Math.Sqrt, x);
    ...
    public void Tanh_Derivative(double x) =>
        AssertMatchesFD(DualFunctions<double>.Tanh, Math.Tanh, x);
    ...
    {
        double n = 3.0;
        var ad = DualFunctions<double>.Pow(DualNumber<double>.Variable(x), n).Dual;
    ...
    {
        var r = DualFunctions<double>.Abs(DualNumber<double>.Variable(2.0));
    ...
    {
        var r = DualFunctions<double>.Abs(DualNumber<double>.Variable(-3.0));
